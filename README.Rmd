...
```{r child="vignettes/rmdchunks/installation.Rmd"}
```

```{r child="vignettes/rmdchunks/usage_intro.Rmd"}
```

```{r child="vignettes/rmdchunks/finding_markers.Rmd"}
```

```{r child="vignettes/rmdchunks/visualizing_markers.Rmd"}
```

```{r child="vignettes/rmdchunks/suggesting_strategies.Rmd"}
```

```{r child="vignettes/rmdchunks/antibodies.Rmd"}
```
